...
class VGGUnetModel(SegmentationModel):
    def __init__(self, n_channels, n_classes, lr, bilinear, eval_batchsize=1):
        assert n_channels == 1
        super(VGGUnetModel, self).__init__(n_channels, n_classes)
        self.net = VGGUNet(n_classes, bilinear=bilinear)
