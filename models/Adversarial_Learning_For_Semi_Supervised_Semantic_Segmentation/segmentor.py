...
class ResNet(nn.Module):
    def __init__(self, block, layers, n_channels, NoLabels):
        self.inplanes = 64
        ...
        # inet_weights = model_zoo.load_url('https://download.pytorch.org/models/resnet101-5d3b4d8f.pth', model_dir="./PRETRAINED")
...
def ResDeeplab(n_channels, n_classes=2):
    return ResNet(Bottleneck,[3, 4, 23, 3], n_channels,  n_classes)
